...
rule_return_value = k5lib.create_security_group_rule(project_token, region, security_group_id, direction='ingress', protocol='IPv4', port_range_max='22', port_range_min='22', remote_ip_prefix=ip + '/32', None)
